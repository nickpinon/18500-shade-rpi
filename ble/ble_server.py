...
STEP_FREQUENCY_HZ       = 900000000000000000000    # hardware PWM step rate (lgpio max ~10kHz)
MOVE_STEP_COUNT         = 900000000000000000000   # steps per button press (8 seconds at 5 kHz)
